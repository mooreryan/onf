 ...
 *
 * @warning If you try and hash an int32_t_array with length > 15, I will return an error as you may overflow the integer!
 *
 ...
 * @retval ONF_ERROR_INT if int32_t_array size is > 15.  Anything bigger than this could overflow the integer.
 */
int32_t onf_hash_int32_t_array(struct onf_int32_t_array* ary);

/**
 * @brief Returns an int32_t array for counts of the correct size for counting kmers.
